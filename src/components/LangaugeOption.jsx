    ...
    return (
        <div className="langauge-choose">
            ...
            <div className="cotainer-language">
                    ...
                    <div>
                        <Link onClick={() => localStorage.setItem('lan',true)} style={{fontSize:'30px',textDecoration:'none',color:'white'}} to="/">Albania</Link>
                        <span style={{fontSize:'30px',cursor:'pointer',color:'white'}}> / </span>
                        <Link onClick={() => localStorage.setItem('lan',true)} style={{fontSize:'30px',textDecoration:'none',color:'white'}} to="/en">English</Link>
                    </div>
            </div>
        </div>
    )
